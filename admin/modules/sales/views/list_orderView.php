                        ...
                        <table class="table list-table-wp table-hover">
                            ...
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th><span class="thead-text">Mã đơn hàng</span></th>
                                    <th><span class="thead-text">Họ và tên</span></th>
                                    <th><span class="thead-text">Tên Đăng Ký </span></th>
                                    <th><span class="thead-text">Tổng sản phẩm</span></th>
...
<script>
    $(document).ready(function() {
        seach_item("?mod=sales&action=getListOrder");
        get_list_data("?mod=sales&action=getListOrder");
    })
</script>